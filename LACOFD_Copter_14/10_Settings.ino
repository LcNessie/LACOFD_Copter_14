...
const float flashCooldown[] = {1.015, 1.015}; // Cooldown factor. Higher number means faster cooldown.
const float flashHeatup[] = {1.05, 1.05};     // Heatup factor. Higher number means faster heatup.
...
const int strobeTime[] = {2200, 2165};        //Number milliseconds per cycle.
